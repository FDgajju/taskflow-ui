...
const DebounceTasks: React.FC<{
  ...
  loading: boolean;
}> = ({ tasks, handleClick, loading }) => {
  return (
    <div className="absolute bottom-16 w-full z-10 max-h-80 overflow-y-auto text-main border-1 border-btn-primary/50 drop-shadow-md drop-shadow-main/40 bg-secondary-bg rounded-xl p-3 flex flex-col gap-1">
